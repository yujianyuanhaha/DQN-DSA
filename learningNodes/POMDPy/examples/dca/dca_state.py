...
class DCAState(DiscreteState):
    """
    Enumerated state for the DCA POMDP
    ...
    The list "door_prizes" contains 0's for doors that have DCAs behind them, and 1's
    for doors that have prizes behind them. This part of the state is obscured. Listening
    actions are necessary to increase confidence in choosing the right door. A single DCAState represents a
...
#
#    def copy(self):
#        return DCAState(self.door_open, self.door_prizes)
#
