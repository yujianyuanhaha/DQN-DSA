...
class DDPG(object):
    ...
    def __init__(self, ddpgNode, a_dim, s_dim, a_bound,):
        ...
        a_ = self._build_a(self.S_,  custom_getter=ema_getter)   # replaced target parameters
    ...
    def _build_a(self, s, reuse=tf.AUTO_REUSE, custom_getter=None):
    ...
    def _build_c(self, s, a, reuse=tf.AUTO_REUSE, custom_getter=None):
        trainable = True if reuse is None else False
